...
namespace Com.WaitWha.Checkmarx.Utils
{
    public class StringUtils
    {
        ...
        /// <summary>
        /// Encrypts the given SecureString for more permenant storage using the Data Protection API (DPAPI) available in 
        /// Microsoft Windows 2000 and later operating systems.
        /// </summary>
        ...
        /// <summary>
        /// Decrypts a given string using the given salt and the Data Protection API (DPAPI) available in Microsoft Windows 
